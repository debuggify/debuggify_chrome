...
var F = {
  ...
  getCode: function (callback) {
    ...
    // var url = "http://cdn.debuggify.net/js/awd/debuggify.logger.http.js";
    // $.getScript("http://cdn.debuggify.net/js/awd/debuggify.logger.http.js ", function(script, textStatus, jqXHR) {
